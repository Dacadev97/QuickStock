            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <select class="form-control" id="producto_id" name="producto_id" required>
                        ...
                        @foreach($products as $product)
                            <option value="{{ $product->id }}" data-referencia="{{ $product->referencia }}" data-precio="{{ $product->precio }}" data-peso="{{ $product->peso }}" data-categoria="{{ $product->categoria }}" data-stock="{{ $product->stock }}">
